// lib/views/screens/warehouse/order_an_details.dart

import 'package:flutter/material.dart';
import '../../../utils/constants.dart';
import '../../../views/widgets/auth_widgets.dart';

class OrderAnDetailsScreen extends StatefulWidget {
  const OrderAnDetailsScreen({super.key});

  @override
  State<OrderAnDetailsScreen> createState() => _OrderAnDetailsScreenState();
}

class _OrderAnDetailsScreenState extends State<OrderAnDetailsScreen> {
  // مصفوفة تفاعلية لإدارة حالة فحص المنتجات الثلاثة داخل واجهة الاسترداد
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          // 1. الهيدر المشترك - يحمل العنوان المطابق تماماً للواجهة بالصورة: Details an Order
          ReceivingTopHeader(
            height: screenHeight * 0.22,
            title: 'Details an Order',
          ),
